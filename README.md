...
- [0x更新经济治理模型](https://www.youtube.com/watch?v=s2wlzlQxd5E&feature=youtu.be) 0x protocol在Defi中的影响力一直非常高，各大主流Defi项目都在使用其协议，但是其token的utility却一直受到质疑。甜甜圈很欣慰的看到0x社区也对于这个问题做出了改进。他们对于经济模型做了更改，最核心的是定位在他们把market maker，也就是提供流动性的做市商作为目标用户，使其对使用协议维护协议产生积极性。所以经济模型会通过收取taker的费用来激励maker部分参与治理。
...
- **关于去中心化治理**
	- **居高不下的稳定费率是否会引起maker的治理争议：**由于DAI一直处于折价状态，在4月18日，maker基金会已经投票将[dai的稳定费率提高到14.5%](http://www.btb8.com/mkr/1904/44710.html)。居高不下的稳定费率引起了maker社区的争议， 甚至以太坊的研究员[Justin Ðrake](https://twitter.com/drakefjustin)在推特中发布了Fork makerdao的言论。从潘超在社群的发言中，看到目前提高稳定费率是权宜之计，还是需要近期引入多资产抵押（相关性低的）来降低与以太坊价格的绑定。另外以太坊若下跌，可能也会提高Dai的需求。甜甜圈认为很有趣，maker和dai目前已经是Defi的老大哥，若真的继续提高利率乃至引起分叉的争议，一定会引起整个社区的“地震”，我们会持续保持关注。（此外，一个有趣的现象是，Dharma提供8.5%的抵押利率使其锁定的以太坊上涨3倍超过了uniswap) 
...
- **IEO观点**  [从博弈论视角看IEO：你是“智猪”还是“蠢猪”?](https://mp.weixin.qq.com/s/85Tu2JfSxFuceUeo-nmz9w)  闪电从博弈论的角度来分析IEO这个游戏，但是同样我们从另外一个维度去思考，没有持续饲料的游戏可以玩多久？
